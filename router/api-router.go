...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.DELETE("/notice", middleware.RootAuth(), controller.DeleteNotice)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/wechat/notify", controller.WeChatNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/topup/status", middleware.CriticalRateLimit(), controller.GetTopUpOrderStatus)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup/stats", controller.GetAdminTopUpOverview)
				adminRoute.GET("/topup/records", controller.GetAdminTopUpRecords)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/order/status", middleware.CriticalRateLimit(), controller.GetSubscriptionOrderStatus)
